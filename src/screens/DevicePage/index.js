						...
						<div className='md:w-1/2 md:ml-5 flex flex-col order-2'>
							<div className='space-y-2 mt-5 text-black border-b-2 pb-2 border-sky-400 rounded-xl'>
								...
								<p className='  ml-5 text-left'>
									...
									Don’t get stuck waiting for your service to kick in after
									you’ve already paid. Just follow a few simple steps and get
									instant access to your mobile service:
								</p>
								...
								<p className='text-left ml-5'>
									{' '}
									It’s as simple as that! As soon as the payment is processed,
									you will be able to use your phone to contact friends and
							...
							<div className=' space-y-2 mt-5 text-black border-b-2  pb-2 border-sky-400  rounded-xl'>
								...
								<p className='  ml-5 text-left'>
									...
									working days and our "Next Day" orders are delivered on the
									next day for orders that are placed Monday to Friday before
									8pm (6:30pm for Next Day Order & Collect). For orders placed
									on Fri after 8pm (6:30pm for Next Day Order & Collect) or on
									Saturday and Sunday, these will be delivered by Tuesday.
								</p>
								...
								<p className='text-left ml-5'>
									...
									Hermes directly if you have any queries about your delivery.
									You can contact Hermes here.
								</p>
								<p className='text-left ml-5'>
									...
									use the app to rearrange your delivery or update your safe
									place locations if you’re not going to be home. You can
									download the Hermes app for Apple via the App Store or via
